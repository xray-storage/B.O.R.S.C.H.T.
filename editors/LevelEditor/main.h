...
__published:	// IDE-managed Components
	...
	TMenuItem *miMakeSoundEnvironment;
	TMenuItem *Help1;
	TMenuItem *N23;
	TMenuItem *About1;
	TMenuItem *OnlineHelp1;
	...
	void __fastcall miMakeSoundEnvironmentClick(TObject *Sender);
	void __fastcall OnlineHelp1Click(TObject *Sender);
